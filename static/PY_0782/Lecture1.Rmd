---
title: 'Lecture 1: PY 0782 - Advanced Quantitative Research Methods'
author: "Dr. Thomas Pollet, Northumbria University (thomas.pollet@northumbria.ac.uk)"
date: '`r format(Sys.Date())` | [disclaimer](http://sites.google.com/site/thomasvpollet/disclaimer)'
output:
...
knitr::include_graphics("http://s2.quickmeme.com/img/74/74e004eeea3edb4c231d09763dfacf85bb6bf56184b0dfc8c7aaaf5ed3e55a27.jpg")
```


## Housekeeping {.build} 
```{r, out.width = "300px", echo=FALSE}
knitr::include_graphics("http://cdn.meme.am/instances/42056161/housekeeping.jpg")
```
 ...
 Questions on assignments. Exercise after each assignment.
...
### The bit you care about most: marks. {.build} 
 ...
 Deadlines: see Turnitin briefs (1pm)
...
* Many companies rely on R (e.g., Facebook, Google, Shell, Thomas Cook,... ). Some newspapers rely on R to make their graphics. 
...
## Try it yourself {.build}
 ...
 Find our more about write_spss function.
...
##Some basic data analyses / manipulations. {.build} 
 ...
 [library](https://yihui.name/en/2014/07/library-vs-require/) (instead of require - require tries to load library). I'll alternate.
...
```
```{r, out.width = "300px", echo=FALSE}
knitr::include_graphics("https://pics.me.me/this-is-bran-bran-knows-everything-yet-he-does-not-27295932.png")
```
...
knitr::include_graphics("https://cdn.meme.am/instances/61123698/floating-point-cat-approves.jpg") 
```
...
knitr::include_graphics("https://cdn.meme.am/instances/68199295/hey-girl-nothing-is-more-important-than-your-confidence-interval.jpg")
```
